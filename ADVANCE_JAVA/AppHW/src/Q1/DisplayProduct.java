...
//		dao.UpdateName(id1, pname);
//		dao.UpdateNameCost(id1, pname, price);
//		dao.UpdateNamePrice(id1, pname, price);
		//pw.println("ID : <input type='number' name='pid' value=" + id1 + " readonly ");
		//pw.println("<br/><br/><br/> Update Name : <input type='text' name='pname' />");
		//pw.println("<br/><br/>Update price:<input type='number' name='price' />");
